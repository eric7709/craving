      ...
      <div className="w-60 p-5 h-fit rounded-xl bg-slate-800 shadow-lg text-center space-y-3">
        ...
        <div className="grid grid-cols-2 justify-center gap-2 pt-1">
          ...
          <button
            ...
            disabled={isPending}
            className={` h-9 rounded-lg text-xs text-white 
            ${
              isPending
